...
results of each competition, write a function that returns the winner of the tournament. 
...
# ------------------------ memory O(k), k is the number of teams, time O(N), n is the len of the results list

def tournamentWinner(competitions:List[str], results:List[int]):
