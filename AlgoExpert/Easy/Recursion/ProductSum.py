...
# O(n) time: where n is the len of the array including the "special" elements
# O(d) space: where d is the deeper "special" elements
def productSum(array: list, depth=1) -> int:
    product_sum = 0
    for item in array:
